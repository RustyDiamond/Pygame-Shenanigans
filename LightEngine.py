...
while True:
	...
	if rotation:
		...
		pygame.draw.line(display, (190,190,190), (5,95), (72,95),5)		#rotation ui strikethrough
	...
	if not reflect:
		pygame.draw.line(display, (190,190,190), (5,75), (80,75),5)		#reflection ui strikethrough
